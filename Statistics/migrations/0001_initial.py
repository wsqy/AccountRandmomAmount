    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='任务日期')),
                ('amount_total', models.IntegerField(default=0, verbose_name='日总交易金额(万元)')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Account.Company', verbose_name='集团子公司')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(blank=True, default=0, help_text='备货量', null=True, verbose_name='备货量')),
                ('choice_scale', models.FloatField(blank=True, default=Statistics.models.DaySellerProducts.random_choice_scale, help_text='备货比例', null=True, verbose_name='备货比例')),
