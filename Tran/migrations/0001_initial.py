    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_total_min', models.PositiveIntegerField(default=2000, verbose_name='每日总金额下限(万元)')),
                ('amount_total_max', models.PositiveIntegerField(default=4000, verbose_name='每日总金额上限(万元)')),
                ...
                ('corporation', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='Account.Corporation', verbose_name='所属交易场所')),
            ],
            options={
                'verbose_name': '每日任务',
